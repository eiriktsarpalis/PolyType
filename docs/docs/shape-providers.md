...
Types annotated with [`KnownTypeAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.knowntypeattribute) are recognized regardless of whether [`DataContractAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.datacontractattribute) is present, consistent with how `DataContractSerializer` honors known types on plain types. If the type also declares <xref:PolyType.DerivedTypeShapeAttribute> annotations, those take precedence and any [`KnownTypeAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.knowntypeattribute) annotations are ignored.

Types not annotated with [`DataContractAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.datacontractattribute) ignore [`DataMemberAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.datamemberattribute) annotations, but will honor [`IgnoreDataMemberAttribute`](https://learn.microsoft.com/dotnet/api/system.runtime.serialization.ignoredatamemberattribute) annotations if present.
