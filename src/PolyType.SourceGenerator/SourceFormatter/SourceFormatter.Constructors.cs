                                                            ...
                                                            .Concat(constructor.OptionalMembers))
        {
            ...
            writer.WriteLine($$"""
                new global::PolyType.SourceGenModel.SourceGenParameterShape<{{constructorArgumentStateFQN}}, {{parameter.ParameterType.FullyQualifiedName}}>(this)
                {
                    ...
                    ParameterTypeSetter = {{GetShapeModel(parameter.ParameterType).SourceIdentifier}},
                    KindSetter = {{FormatParameterKind(parameter)}},
                    IsRequiredSetter = {{FormatBool(parameter.IsRequired)}},
                    IsNonNullableSetter = {{FormatBool(parameter.IsNonNullable)}},
                    IsPublicSetter = {{FormatBool(parameter.IsPublic)}},
                    HasDefaultValueSetter = {{FormatBool(parameter.HasDefaultValue)}},
                    DefaultValueSetter = {{FormatDefaultValueExpr(parameter)}},
