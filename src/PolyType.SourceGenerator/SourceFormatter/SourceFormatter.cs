...
internal sealed partial class SourceFormatter(TypeShapeProviderModel provider)
{
    ...
    private static void StartFormatSourceFile(
        SourceWriter writer,
        TypeDeclarationModel typeDeclaration,
        ImmutableEquatableArray<string> suppressedDiagnosticIds)
    {
        ...
        foreach (string diagnosticId in suppressedDiagnosticIds)
        {
            writer.WriteLine($"#pragma warning disable {diagnosticId}", disableIndentation: true);
        }
