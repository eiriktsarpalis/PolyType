...
internal sealed partial class SourceFormatter
{
    private void FormatOptionalTypeShapeFactory(SourceWriter writer, string methodName, OptionalShapeModel optionalShapeModel)
    {
        ...
        string? attributesFactoryName = GetAttributesFactoryName(optionalShapeModel);
        ...
        writer.WriteLine($$"""
            private global::PolyType.ITypeShape<{{optionalShapeModel.Type.FullyQualifiedName}}> {{methodName}}()
            {
                ...
                {
                    ElementTypeFactory = () => {{GetShapeModel(optionalShapeModel.ElementType).SourceIdentifier}},
        ...
        if (attributesFactoryName is not null)
        {
            writer.WriteLine();
            FormatAttributesFactory(writer, attributesFactoryName, optionalShapeModel.Attributes);
        }
