...
{
    private const string LaunchDebuggerOnStartEnvVar = "POLYTYPE_LAUNCH_DEBUGGER_ON_START";
    private const string LaunchDebuggerOnExceptionEnvVar = "POLYTYPE_LAUNCH_DEBUGGER_ON_EXCEPTION";
