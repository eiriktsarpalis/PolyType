...
public interface IEnumerableTypeShape<TEnumerable, TElement> : ITypeShape<TEnumerable>, IEnumerableTypeShape
{
    ...
    Func<TEnumerable> GetDefaultConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions);
    ...
    SpanConstructor<TElement, TEnumerable> GetSpanConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions);
    ...
    Func<IEnumerable<TElement>, TEnumerable> GetEnumerableConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions);
}