    ...
    where TKey : notnull
{
    ...
    /// </summary>
    /// <param name="collectionConstructionOptions">Options that control how the collection is constructed.</param>
    ...
    Func<TDictionary> GetDefaultConstructor(CollectionConstructionOptions<TKey> collectionConstructionOptions);
    ...
    SpanConstructor<KeyValuePair<TKey, TValue>, TDictionary> GetSpanConstructor(CollectionConstructionOptions<TKey> collectionConstructionOptions);
    ...
    Func<IEnumerable<KeyValuePair<TKey, TValue>>, TDictionary> GetEnumerableConstructor(CollectionConstructionOptions<TKey> collectionConstructionOptions);
}
