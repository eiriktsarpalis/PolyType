...
internal abstract class ReflectionEnumerableTypeShape<TEnumerable, TElement>(ReflectionTypeShapeProvider provider) : ReflectionTypeShape<TEnumerable>(provider), IEnumerableTypeShape<TEnumerable, TElement>
{
    ...
    public virtual Func<TEnumerable> GetDefaultConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions)
    {
        if (ConstructionStrategy is not CollectionConstructionStrategy.Mutable)
        {
            Throw();
    ...
    public virtual Func<IEnumerable<TElement>, TEnumerable> GetEnumerableConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions)
    {
    ...
    public virtual SpanConstructor<TElement, TEnumerable> GetSpanConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions)
    {
    ...
    : ReflectionEnumerableTypeShape<TElement[], TElement>(provider)
{
    ...
    public override SpanConstructor<TElement, TElement[]> GetSpanConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions) => static span => span.ToArray();
}
    ...
    : ReflectionEnumerableTypeShape<ReadOnlyMemory<TElement>, TElement>(provider)
{
    ...
    public override SpanConstructor<TElement, ReadOnlyMemory<TElement>> GetSpanConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions) => static span => span.ToArray();
}
    ...
    : ReflectionEnumerableTypeShape<Memory<TElement>, TElement>(provider)
{
    ...
    public override SpanConstructor<TElement, Memory<TElement>> GetSpanConstructor(CollectionConstructionOptions<TElement> collectionConstructionOptions) => static span => span.ToArray();
}