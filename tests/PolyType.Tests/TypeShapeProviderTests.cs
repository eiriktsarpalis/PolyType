...
public abstract class TypeShapeProviderTests(ProviderUnderTest providerUnderTest)
{
    ...
    private sealed class DictionaryTestVisitor : TypeShapeVisitor
    {
        public override object? VisitDictionary<TDictionary, TKey, TValue>(IDictionaryTypeShape<TDictionary, TKey, TValue> dictionaryShape, object? state)
        {
            ...
            {
                var defaultCtor = dictionaryShape.GetDefaultConstructor(CollectionConstructionOptions<TKey>.Default);
                var adder = dictionaryShape.GetAddKeyValuePair();
                Assert.Same(dictionaryShape.GetDefaultConstructor(CollectionConstructionOptions<TKey>.Default), dictionaryShape.GetDefaultConstructor(CollectionConstructionOptions<TKey>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => dictionaryShape.GetDefaultConstructor(CollectionConstructionOptions<TKey>.Default));
            ...
            {
                var enumerableCtor = dictionaryShape.GetEnumerableConstructor(CollectionConstructionOptions<TKey>.Default);
                Assert.Same(dictionaryShape.GetEnumerableConstructor(CollectionConstructionOptions<TKey>.Default), dictionaryShape.GetEnumerableConstructor(CollectionConstructionOptions<TKey>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => dictionaryShape.GetEnumerableConstructor(CollectionConstructionOptions<TKey>.Default));
            }

            if (dictionaryShape.ConstructionStrategy is CollectionConstructionStrategy.Span)
            {
                var spanCtor = dictionaryShape.GetSpanConstructor(CollectionConstructionOptions<TKey>.Default);
                Assert.Same(dictionaryShape.GetSpanConstructor(CollectionConstructionOptions<TKey>.Default), dictionaryShape.GetSpanConstructor(CollectionConstructionOptions<TKey>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => dictionaryShape.GetSpanConstructor(CollectionConstructionOptions<TKey>.Default));
            }
    ...
    private sealed class EnumerableTestVisitor : TypeShapeVisitor
    {
        public override object? VisitEnumerable<TEnumerable, TElement>(IEnumerableTypeShape<TEnumerable, TElement> enumerableShape, object? state)
        {
            ...
            {
                var defaultCtor = enumerableShape.GetDefaultConstructor(CollectionConstructionOptions<TElement>.Default);
                var adder = enumerableShape.GetAddElement();
                Assert.Same(enumerableShape.GetDefaultConstructor(CollectionConstructionOptions<TElement>.Default), enumerableShape.GetDefaultConstructor(CollectionConstructionOptions<TElement>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => enumerableShape.GetDefaultConstructor(CollectionConstructionOptions<TElement>.Default));
            ...
            {
                var enumerableCtor = enumerableShape.GetEnumerableConstructor(CollectionConstructionOptions<TElement>.Default);
                Assert.Same(enumerableShape.GetEnumerableConstructor(CollectionConstructionOptions<TElement>.Default), enumerableShape.GetEnumerableConstructor(CollectionConstructionOptions<TElement>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => enumerableShape.GetEnumerableConstructor(CollectionConstructionOptions<TElement>.Default));
            }

            if (enumerableShape.ConstructionStrategy is CollectionConstructionStrategy.Span)
            {
                var spanCtor = enumerableShape.GetSpanConstructor(CollectionConstructionOptions<TElement>.Default);
                Assert.Same(enumerableShape.GetSpanConstructor(CollectionConstructionOptions<TElement>.Default), enumerableShape.GetSpanConstructor(CollectionConstructionOptions<TElement>.Default));
            ...
            {
                Assert.Throws<InvalidOperationException>(() => enumerableShape.GetSpanConstructor(CollectionConstructionOptions<TElement>.Default));
            }
