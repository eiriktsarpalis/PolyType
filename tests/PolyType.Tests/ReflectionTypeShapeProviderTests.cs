...
public static class ReflectionTypeShapeProviderTests
{
    ...
    {
        Assert.SkipWhen(TestHelpers.IsUnloadUnreliableEnvironment(), "Collectible AssemblyLoadContext unload is unreliable on macOS and under non-Windows profiling.");
